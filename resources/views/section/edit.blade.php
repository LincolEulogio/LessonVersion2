<x-app-layout>
    <div class="py-10 px-4 sm:px-6 lg:px-8 w-full max-w-5xl mx-auto">
        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
                ...
                <p class="text-slate-500 dark:text-slate-400 text-sm font-medium mt-1 uppercase tracking-tighter">
                    {{ __('Modificando detalles de: :name', ['name' => $section->section]) }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <form action="{{ route('section.update', $section->sectionID) }}" method="POST" class="p-8 md:p-12">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-12">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="category" id="category"
                                    value="{{ old('category', $section->category) }}"
                                    ...
                                    @foreach ($teachers as $teacher)
                                        <label
                                            ...
                                            <input type="radio" name="teacherID" value="{{ $teacher->teacherID }}"
                                                class="sr-only peer"
                                                {{ old('teacherID', $section->teacherID) == $teacher->teacherID ? 'checked' : '' }}>
                        ...
                        <div class="space-y-3 md:col-span-2">
                            ...
                            <div class="relative group">
                                ...
                                <textarea name="note" id="note" rows="5"
                                    ...
                                    class="w-full pl-14 pr-6 py-4 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/50 rounded-2xl text-slate-700 dark:text-slate-200 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all outline-none resize-none font-medium text-sm leading-relaxed">{{ old('note', $section->note) }}</textarea>
                            </div>
                    ...
                    <div
                        ...
                        <button type="submit"
                            class="w-full md:w-auto px-12 py-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3 shadow-xl shadow-emerald-500/20">
