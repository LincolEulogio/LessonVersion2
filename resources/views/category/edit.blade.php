                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <select name="hostelID" id="hostelID" required
                            ...
                            @foreach ($hostels as $hostel)
                                <option value="{{ $hostel->hostelID }}"
                                    {{ old('hostelID', $category->hostelID) == $hostel->hostelID ? 'selected' : '' }}>
                                    {{ $hostel->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="class_type" id="class_type"
                            value="{{ old('class_type', $category->class_type) }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="hbalance" id="hbalance"
                                value="{{ old('hbalance', $category->hbalance) }}" required
