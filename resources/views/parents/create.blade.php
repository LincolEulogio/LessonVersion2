            ...
            <form action="{{ route('parents.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-user-plus text-sky-400 text-xl"></i>
                        Datos del Tutor
                    </h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="email" class="text-sm font-medium text-slate-400">Email de Contacto</label>
                ...
                <div class="space-y-2">
                    <label for="address" class="text-sm font-medium text-slate-400">Dirección Domiciliaria</label>
                    <textarea name="address" id="address" rows="2"
                        class="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-slate-200 focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-all">{{ old('address') }}</textarea>
                </div>
