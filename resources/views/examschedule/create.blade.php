    ...
    <div class="py-10 px-4 sm:px-6 lg:px-8 w-full max-w-5xl mx-auto">
        ...
        <div class="mb-12">
            ...
            <nav class="flex items-center gap-3 text-slate-400 mb-8">
                ...
                <span
                    class="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500/60">{{ __('Nueva Programación') }}</span>
            </nav>

            <div class="space-y-4">
                <h1
                    class="text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tighter uppercase italic leading-none">
                    {{ __('Programar') }} <span class="text-emerald-500 relative inline-block">
                        {{ __('Examen') }}
                ...
                <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.4em] flex items-center gap-3">
                    ...
                    {{ __('Asigna fecha, hora y ubicación para las evaluaciones') }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <form action="{{ route('examschedule.store') }}" method="POST" class="p-10 space-y-10 font-bold">
                @csrf
                            ...
                            <select name="examID" id="examID"
                                ...
                                @foreach ($exams as $exam)
                                    <option value="{{ $exam->examID }}"
                                        {{ old('examID') == $exam->examID ? 'selected' : '' }}>{{ $exam->exam }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div
                    ...
                    <div class="space-y-3 group/item">
                        ...
                        <div class="relative">
                            ...
                            <select id="sectionID" name="sectionID" disabled
                                class="w-full pl-14 pr-6 py-4 bg-slate-100 dark:bg-slate-900/30 border {{ $errors->has('sectionID') ? 'border-rose-500' : 'border-slate-200 dark:border-slate-700/30' }} rounded-2xl text-slate-400 dark:text-slate-500 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all outline-none appearance-none cursor-not-allowed">
                                <option value="">{{ __('Esperando clase...') }}</option>
                            </select>
                        </div>
                        @error('sectionID')
                            <p
                    ...
                    <div class="space-y-3 group/item">
                        ...
                        <div class="relative">
                            ...
                            <select id="subjectID" name="subjectID" disabled
                                class="w-full pl-14 pr-6 py-4 bg-slate-100 dark:bg-slate-900/30 border {{ $errors->has('subjectID') ? 'border-rose-500' : 'border-slate-200 dark:border-slate-700/30' }} rounded-2xl text-slate-400 dark:text-slate-500 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all outline-none appearance-none cursor-not-allowed">
                                <option value="">{{ __('Esperando clase...') }}</option>
                            </select>
                        </div>
                        @error('subjectID')
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="space-y-3 md:col-span-2 group/item">
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="edate" value="{{ old('edate') }}"
                    ...
                    <div class="space-y-3 group/item">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" name="examfrom" value="{{ old('examfrom') }}"
                    ...
                    <div class="space-y-3 group/item">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" name="examto" value="{{ old('examto') }}"
                ...
                <div class="space-y-3 group/item">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="room" value="{{ old('room') }}" maxlength="255"
