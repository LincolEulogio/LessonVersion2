        ...
        <div
            ...
            <div
                ...
                <div class="relative z-10">
                    <h2 class="text-2xl font-black text-slate-800 dark:text-white tracking-tight mb-2">Editar Examen</h2>
                    <p class="text-slate-500 dark:text-slate-400 text-sm">Actualice la información de la evaluación
                        programada.</p>
                </div>
            </div>
