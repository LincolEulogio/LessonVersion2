    ...
    <div class="py-10 px-4 sm:px-6 lg:px-8 w-full max-w-2xl mx-auto">
        ...
        <div class="mb-12">
            ...
            <nav class="flex items-center gap-3 text-slate-400 mb-8">
                ...
                <span
                    class="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500/60">{{ __('Editar Examen') }}</span>
            </nav>
            ...
            <div class="space-y-4">
                ...
                <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.4em] flex items-center gap-3">
                    ...
                    {{ __('Actualización de información de la evaluación programada') }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <form action="{{ route('exam.update', $exam->examID) }}" method="POST" class="p-10 space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-3 group">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="note" id="note" rows="4"
                            ...
                            placeholder="{{ __('Detalles adicionales sobre el examen...') }}">{{ old('note', $exam->note) }}</textarea>
                    </div>
                    @error('note')
                        <p
                            class="text-[10px] font-black text-rose-500 capitalize tracking-widest ml-4 mt-2 italic animate-pulse">
