<x-app-layout>
    <div class="py-8 px-4 sm:px-6 lg:px-8 w-full mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Control de Asistencia</h1>
                <p class="text-slate-500 dark:text-slate-400 mt-1">Gestione la puntualidad y asistencia de los
                    estudiantes.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                    <div class="space-y-2">
                        ...
                        <select name="classesID" id="classesID" onchange="this.form.submit()"
                            class="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/50 rounded-2xl px-4 py-3 text-slate-700 dark:text-slate-200 focus:border-rose-500/50 focus:ring-4 focus:ring-rose-500/10 transition-all outline-none cursor-pointer">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                @forelse($sections as $section)
                                    <a href="{{ route('attendance.add', ['classesID' => $classesID, 'sectionID' => $section->sectionID]) }}"
                                        class="group p-4 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/50 rounded-2xl hover:border-rose-500/50 hover:bg-rose-500/5 transition-all flex items-center gap-4">
                                        <div
                                        ...
                                        <div>
                                            <h4
                                                class="text-slate-800 dark:text-slate-200 font-bold group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors uppercase tracking-wider text-sm">
                                                {{ $section->section }}</h4>
                                            <span
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div
                ...
                <div>
                    <span class="block text-xl font-bold text-slate-900 dark:text-white">Diaria</span>
            ...
            <div
                ...
                <div>
                    <span class="block text-xl font-bold text-slate-900 dark:text-white">{{ date('d M') }}</span>
            ...
            <div
                ...
                <div>
                    <span class="block text-xl font-bold text-slate-900 dark:text-white">Asistencia</span>
