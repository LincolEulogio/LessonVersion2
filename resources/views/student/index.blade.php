        ...
        <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('student.create') }}"
                    class="group flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-bold transition-all shadow-lg shadow-indigo-500/20 active:scale-95">
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr
                            ...
                            <th class="px-6 py-4">Clase / Sección</th>
                        ...
                        @forelse($students as $student)
                            <tr class="group hover:bg-slate-700/20 transition-all duration-200">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if ($student->active)
                                        <span
                                            class="px-3 py-1 bg-green-500/10 text-green-500 border border-green-500/20 rounded-full text-xs font-bold">Activo</span>
                                    @else
                                        <span
                                            class="px-3 py-1 bg-red-500/10 text-red-500 border border-red-500/20 rounded-full text-xs font-bold">Inactivo</span>
                                    @endif
                                </td>
