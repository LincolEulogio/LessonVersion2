    ...
    <div class="py-10 px-4 sm:px-6 lg:px-8 w-full max-w-4xl mx-auto">
        ...
        <div class="mb-12">
            ...
            <nav class="flex items-center gap-3 text-slate-400 mb-8">
                ...
                <span
                    class="text-[10px] font-black uppercase tracking-[0.2em] text-amber-500/60">{{ __('Nuevo Grado') }}</span>
            </nav>

            <div class="space-y-4">
                <h1
                    class="text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tighter uppercase italic leading-none">
                    {{ __('Nuevo') }} <span class="text-amber-500 relative inline-block">
                        {{ __('Grado') }}
                ...
                <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.4em] flex items-center gap-3">
                    ...
                    {{ __('Configuración de escalas de calificación para el sistema') }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <form action="{{ route('grade.store') }}" method="POST" class="p-10 space-y-10 font-bold">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div class="space-y-3 group/item">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="grade" value="{{ old('grade') }}" maxlength="60"
                    ...
                    <div class="space-y-3 group/item">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="point" value="{{ old('point') }}" maxlength="11"
                ...
                <div
                    ...
                    <div class="space-y-3 group/item">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="markfrom" value="{{ old('markfrom') }}"
                    ...
                    <div class="space-y-3 group/item">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="markto" value="{{ old('markto') }}"
                ...
                <div class="space-y-3 group/item">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="note" id="note" rows="4"
                            ...
                            placeholder="{{ __('Descripción opcional del grado...') }}">{{ old('note') }}</textarea>
                    </div>
                    @error('note')
                        <p
