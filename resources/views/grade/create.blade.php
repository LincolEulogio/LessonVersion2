<x-app-layout>
    <div class="py-10 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div class="mb-10 text-center">
            <h1 class="text-4xl font-black text-slate-900 dark:text-white tracking-tighter">Configurar Grado</h1>
            <p class="text-slate-500 dark:text-slate-400 mt-2 font-medium">Define los rangos porcentuales y letras de
                evaluación.</p>
        </div>
        ...
        <div
            ...
            <form action="{{ route('grade.store') }}" method="POST" class="p-12 space-y-10">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-3">
                        ...
                        <input type="text" name="grade" required maxlength="60"
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="text" name="point" required maxlength="11"
                            class="w-full bg-slate-50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-700/50 rounded-2xl text-slate-700 dark:text-slate-200 focus:ring-4 focus:ring-amber-500/20 py-4 px-5 font-bold transition-all"
                ...
                <div
                    ...
                    <div class="space-y-3">
                        <label
                            ...
                            Desde (%)</label>
                        <input type="number" name="markfrom" required
                    ...
                    <div class="space-y-3">
                        <label
                            class="block text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] pl-1">Nota
                            Hasta (%)</label>
                        <input type="number" name="markto" required
                ...
                <div class="space-y-3">
                    ...
                    <textarea name="note" rows="4"
                        class="w-full bg-slate-50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-700/50 rounded-3xl text-slate-700 dark:text-slate-200 focus:ring-4 focus:ring-amber-500/20 py-4 px-5 font-bold transition-all"
                        placeholder="Descripción opcional del grado..."></textarea>
                </div>
                ...
                <div class="flex items-center justify-between pt-10 border-t border-slate-100 dark:border-slate-700/30">
                    ...
                    <button type="submit"
                        class="px-16 py-5 bg-amber-600 hover:bg-amber-500 text-white font-black rounded-3xl shadow-[0_20px_40px_-10px_rgba(217,119,6,0.3)] transition-all hover:scale-[1.02] active:scale-[0.98]">
                        Guardar Grado
                    </button>
                </div>
            </form>
