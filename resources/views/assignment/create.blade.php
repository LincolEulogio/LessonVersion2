<x-app-layout>
    <div class="py-8 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight text-center">Crear Nueva
                Asignación</h1>
            <p class="text-slate-500 dark:text-slate-400 mt-1 text-center font-medium">Define los detalles y plazos de la
                nueva tarea.</p>
        </div>
            ...
            <form action="{{ route('assignment.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" name="deadlinedate"
                            value="{{ old('deadlinedate', now()->format('Y-m-d')) }}" required
                            class="w-full bg-slate-50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-700 rounded-2xl text-slate-700 dark:text-slate-200 focus:ring-2 focus:ring-sky-500 transition-all py-3 px-4">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <select id="subjectID" name="subjectID" required disabled
                            class="w-full bg-slate-50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-700 rounded-2xl text-slate-700 dark:text-slate-200 focus:ring-2 focus:ring-sky-500 transition-all py-3 px-4 opacity-50 cursor-not-allowed">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="5" required
                        ...
                        placeholder="Escribe aquí todas las instrucciones para los estudiantes...">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div
                        ...
                        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400 font-medium">Haz clic o arrastra un
                            archivo</p>
