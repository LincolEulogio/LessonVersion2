<x-app-layout>
    <div class="py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        ...
        <div class="mb-10 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 dark:text-slate-400 text-sm font-medium mt-1">Registra una nueva
        ...
        <div
            ...
            <form action="{{ route('hostel.store') }}" method="POST" class="space-y-8 relative">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required
                            ...
                            placeholder="Ej: Residencia Estudiantil Norte">
                        @error('name')
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="address" id="address" value="{{ old('address') }}" required
                                ...
                                placeholder="Ej: Calle Principal #123, Sector A">
                        </div>
                        @error('address')
                            <p class="mt-1 text-xs font-bold text-rose-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="note" id="note" rows="4"
                            ...
                            placeholder="Capacidad total, servicios incluidos, etc...">{{ old('note') }}</textarea>
                        @error('note')
                            <p class="mt-1 text-xs font-bold text-rose-500">{{ $message }}</p>
                        @enderror
                    </div>
