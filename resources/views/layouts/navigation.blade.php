<div
        ...
        <div class="flex items-center gap-3">
            <div class="relative flex-shrink-0">
                <div
                    ...
                    <img src="{{ $user && $user->photo && $user->photo != 'default.png' ? asset('storage/images/' . $user->photo) : 'https://api.dicebear.com/7.x/avataaars/svg?seed=' . ($user->username ?? 'Guest') }}"
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden p-3 space-y-6 scrollbar-hide">
        <div class="space-y-0.5">
            ...
            <!-- Usuarios -->
            @if ($user && $user->hasPermission('usuario_view'))
            ...
            @if (
                ...
                <div x-data="{ open: {{ request()->routeIs('classes.*') || request()->routeIs('section.*') || request()->routeIs('subject.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        ...
                        @endif
                        @if ($user->hasPermission('tema_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('seccion_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('plan_de_estudios_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('asignacion_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('horario_view'))
            ...
            <!-- Asistencia (Dropdown) -->
            @if ($user && $user->hasAnyPermission(['asistencia_de_estudiante_view', 'asistencia_docente_view']))
                <div x-data="{ open: {{ request()->routeIs('attendance.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        @if ($user->hasPermission('asistencia_de_estudiante_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('asistencia_docente_view'))
            ...
            <!-- Examen (Dropdown) -->
            @if ($user && $user->hasAnyPermission(['examen_view', 'horario_de_examen_view', 'grado_view', 'asistencia_examen_view']))
                <div x-data="{ open: {{ request()->routeIs('exam.*', 'grade.*', 'examschedule.*', 'exam_attendance.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        @if ($user->hasPermission('examen_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('horario_de_examen_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('grado_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('asistencia_examen_view'))
            ...
            @if ($user && $user->hasAnyPermission(['promedio_view', 'porcentaje_promedio_view', 'promocion_view']))
                <div x-data="{ open: {{ request()->routeIs('mark.*', 'markpercentage.*', 'promotion.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        @if ($user->hasPermission('promedio_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('porcentaje_promedio_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('promocion_view'))
            ...
            <!-- Conversación -->
            @if ($user && $user->hasPermission('conversacion_view'))
            ...
            <!-- Compartir -->
            @if ($user && $user->hasPermission('multimedia_view'))
            ...
            <!-- Correo -->
            @if ($user && $user->hasPermission('correo_view'))
            ...
            <!-- Biblioteca (Dropdown) -->
            @if ($user && $user->hasAnyPermission(['miembro_de_la_biblioteca_view', 'libros_view', 'libro_de_publicacion_view']))
                <div x-data="{ open: {{ request()->routeIs('library.*') || request()->routeIs('book.*') || request()->routeIs('lmember.*') || request()->routeIs('issue.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        @if ($user->hasPermission('miembro_de_la_biblioteca_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('libros_view'))
            ...
            <!-- Transporte (Dropdown) -->
            @if ($user && $user->hasAnyPermission(['transporte_view', 'miembro_transporte_view']))
                <div x-data="{ open: {{ request()->routeIs('transport.*') || request()->routeIs('tmember.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        @if ($user->hasPermission('transporte_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('miembro_transporte_view'))
            ...
            <!-- Hospedaje (Dropdown) -->
            @if ($user && $user->hasAnyPermission(['hospedaje_view', 'categoria_hospedaje_view', 'miembro_hospedaje_view']))
                <div x-data="{ open: {{ request()->routeIs('hostel.*') || request()->routeIs('category.*') || request()->routeIs('hmember.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        @if ($user->hasPermission('hospedaje_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('categoria_hospedaje_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('miembro_hospedaje_view'))
            ...
            @if ($user && $user->hasAnyPermission(['tipo_de_tarifa_view', 'factura_view', 'historial_de_pago_view', 'gasto_view']))
                <div x-data="{ open: {{ request()->routeIs('feetypes.*') || request()->routeIs('invoice.*') || request()->routeIs('payment.*') || request()->routeIs('expense.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        @if ($user->hasPermission('tipo_de_tarifa_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('factura_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('historial_de_pago_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('gasto_view'))
            ...
            <!-- Anuncio (Dropdown) -->
            @if ($user && $user->hasAnyPermission(['noticias_view', 'evento_view', 'vacaciones_view']))
                <div x-data="{ open: {{ request()->routeIs('notice.*') || request()->routeIs('event.*') || request()->routeIs('holiday.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        @if ($user->hasPermission('noticias_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('evento_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('vacaciones_view'))
            ...
            <!-- Reportes (Dropdown) -->
            @if ($user && $user->hasPermission('reportes_view'))
                <div x-data="{ open: {{ request()->routeIs('report.*') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open"
                        ...
                        <i class="ti ti-chevron-down text-xs transition-transform duration-300"
                            :class="open ? 'rotate-180 text-amber-600 dark:text-amber-400' :
                                'text-slate-400 dark:text-slate-500'"></i>
                    </button>
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
            ...
            @if (
                $user &&
                    $user->hasAnyPermission([
                        'ano_academico_view',
                        'administrador_del_sistema_view',
                        'usuarios_rol_view',
                        'permiso_view',
                    ]))
                <div x-data="{ open: {{ request()->routeIs('schoolyear.*') || request()->routeIs('systemadmin.*') || request()->routeIs('usertype.*') || request()->routeIs('setting.*') || request()->routeIs('permission.*') ? 'true' : 'false' }} }" class="relative">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        @if ($user->hasPermission('ano_academico_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('administrador_del_sistema_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('usuarios_rol_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('permiso_view'))
                        ...
                        @endif
                        @if ($user->hasPermission('reiniciar_contrasena_view'))
                            <a href="#"
            ...
            <!-- Ajustes Generales -->
            @if ($user && $user->hasPermission('configuracion_general_view'))
