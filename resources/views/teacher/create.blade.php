            ...
            <form action="{{ route('teacher.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-user-plus text-emerald-500 dark:text-emerald-400 text-xl"></i>
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-id text-emerald-500 dark:text-emerald-400 text-xl"></i>
                        Datos Personales
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- DOB -->
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-camera-selfie text-emerald-500 dark:text-emerald-400 text-xl"></i>
