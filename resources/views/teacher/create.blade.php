    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-slate-400">Registre un nuevo docente en la plataforma académica.</p>
            </div>
        ...
        <div class="p-8 rounded-3xl bg-slate-800/30 border border-slate-700/50 backdrop-blur-sm shadow-2xl">
            <form action="{{ route('teacher.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf

                <!-- Profile Info Section -->
                <div>
                    <h3 class="text-lg font-bold text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-user-plus text-emerald-400 text-xl"></i>
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-shield-lock text-emerald-400 text-xl"></i>
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-camera-selfie text-emerald-400 text-xl"></i>
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-2 text-xs text-slate-500">Formato recomendado: Cuadrado. Máx 2MB.</p>
