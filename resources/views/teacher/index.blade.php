        ...
        <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('teacher.create') }}"
                    class="group flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold transition-all shadow-lg shadow-emerald-500/20 active:scale-95">
