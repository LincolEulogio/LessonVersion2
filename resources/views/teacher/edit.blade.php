            ...
            <form action="{{ route('teacher.update', $teacher->teacherID) }}" method="POST"
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-user-edit text-emerald-500 dark:text-emerald-400 text-xl"></i>
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-lock text-emerald-500 dark:text-emerald-400 text-xl"></i>
                        Seguridad
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Username -->
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-camera text-emerald-500 dark:text-emerald-400 text-xl"></i>
                        Fotografía
                    </h3>
