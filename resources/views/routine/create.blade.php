<x-app-layout>
    <div class="py-10 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <div class="mb-10 text-center">
            <h1 class="text-4xl font-black text-slate-900 dark:text-white tracking-tighter">Programar Nuevo Horario</h1>
            <p class="text-slate-500 dark:text-slate-400 mt-2 font-medium">Asigna de forma precisa las horas pedagógicas
                por clase.</p>
        </div>
        ...
        <div
            ...
            <form action="{{ route('routine.store') }}" method="POST" class="p-12 space-y-10">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <select id="sectionID" name="sectionID" required disabled
                            class="w-full bg-slate-50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-700/50 rounded-2xl text-slate-700 dark:text-slate-200 focus:ring-4 focus:ring-indigo-500/20 py-4 px-5 font-bold transition-all opacity-50">
    ...
    <!-- API Routines -->
    <Route path="/api/sections/{classID}" component={null} />
