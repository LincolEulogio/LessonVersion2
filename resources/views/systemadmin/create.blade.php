<x-app-layout>
    <div class="py-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div class="mb-10 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Agregar Administrador</h1>
                <p class="text-slate-500 dark:text-slate-400 text-sm font-medium mt-1">Registra personal con privilegios
                    de gestión</p>
            </div>
        </div>
        ...
        <form action="{{ route('systemadmin.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            ...
            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
                    ...
                    <div class="space-y-2">
                        ...
                        <x-form.input name="dni" id="dni" required />
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        <x-form.label for="photo">Foto de Perfil</x-form.label>
