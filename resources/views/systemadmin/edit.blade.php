    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-slate-400">Modificando perfil administrativo de: <span
                        class="text-purple-400 font-bold uppercase">{{ $systemadmin->username }}</span></p>
            </div>
            ...
            <form action="{{ route('systemadmin.update', $systemadmin->systemadminID) }}" method="POST"
                ...
                <div>
                    <h3 class="text-lg font-bold text-slate-100 flex items-center gap-2 mb-6">
                        <i class="ti ti-user-edit text-purple-400 text-xl"></i>
                        Datos de Identidad
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" id="name"
                                value="{{ old('name', $systemadmin->name) }}" required
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="dni" id="dni"
                                value="{{ old('dni', $systemadmin->dni) }}" required
                                class="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-slate-200 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="dob" class="text-sm font-medium text-slate-400">Fecha de Nacimiento <span
                                class="text-red-500">*</span></label>
                        <input type="date" name="dob" id="dob" value="{{ old('dob', $systemadmin->dob) }}"
                            required
                            class="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-slate-200 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="sex" id="sex"
                            ...
                            <option value="Masculino"
                                {{ old('sex', $systemadmin->sex) == 'Masculino' ? 'selected' : '' }}>Masculino</option>
                            <option value="Femenino"
                                {{ old('sex', $systemadmin->sex) == 'Femenino' ? 'selected' : '' }}>Femenino</option>
                        </select>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="email" name="email" id="email"
                            value="{{ old('email', $systemadmin->email) }}" required
                            class="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-slate-200 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="phone" id="phone"
                            value="{{ old('phone', $systemadmin->phone) }}"
                            class="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-slate-200 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all">
                    ...
                    <div class="space-y-2">
                        <label for="jod" class="text-sm font-medium text-slate-400">Fecha de Alta <span
                                class="text-red-500">*</span></label>
                        <input type="date" name="jod" id="jod" value="{{ old('jod', $systemadmin->jod) }}"
                            required
                            class="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-slate-200 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="address" id="address" rows="2"
                        class="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-slate-200 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all">{{ old('address', $systemadmin->address) }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="username" id="username"
                            value="{{ old('username', $systemadmin->username) }}" required
                            class="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-slate-200 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all">
                ...
                <div class="flex items-center gap-6">
                    <div class="w-24 h-24 rounded-2xl border-2 border-slate-700 flex items-center justify-center text-slate-500 overflow-hidden shadow-inner bg-slate-900/30"
    ...
    <script>
        document.getElementById('photo').onchange = evt => {
            ...
            if (file) {
                ...
                container.classList.add('border-purple-500/50');
            }
        }
    </script>
</x-app-layout>
