<x-app-layout>
    <div class="py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        ...
        <div class="mb-10 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 dark:text-slate-400 text-sm font-medium mt-1">Configura los detalles del
                        trayecto escolar</p>
                </div>
            </div>
        ...
        <div
            ...
            <form action="{{ route('transport.store') }}" method="POST" class="space-y-8 relative">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="note" id="note" rows="4"
                        ...
                        placeholder="Detalles adicionales sobre paradas, horarios o conductor...">{{ old('note') }}</textarea>
                    @error('note')
                        <p class="mt-1 text-xs font-bold text-rose-500">{{ $message }}</p>
                    @enderror
                </div>
