        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 dark:text-slate-400 text-sm font-medium mt-1">Configuración de conceptos de
                        cobro escolar</p>
                </div>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('feetypes.create') }}"
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr
                            ...
                            <th class="px-6 py-4">Concepto de Tarifa</th>
                            <th class="px-6 py-4">Descripción / Notas</th>
                        ...
                        @forelse($feetypes as $type)
                            <tr class="group hover:bg-emerald-50/30 dark:hover:bg-emerald-500/5 transition-all">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-500/20 shadow-sm">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('feetypes.edit', $type->feetypesID) }}"
                                        ...
                                        <form action="{{ route('feetypes.destroy', $type->feetypesID) }}" method="POST"
                                            class="inline" onsubmit="return confirm('¿Eliminar este tipo de tarifa?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-20 text-center">
                                    <div
                                        ...
                                        <i class="ti ti-coin text-4xl"></i>
                                    </div>
                                    <h3 class="text-xl font-bold text-slate-900 dark:text-white">No hay tipos de tarifas
                                    </h3>
                                    <p class="text-slate-400 dark:text-slate-500 mt-2">Registra conceptos como
                                        Colegiatura, Matrícula, etc.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
