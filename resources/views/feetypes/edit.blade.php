<x-app-layout>
    <div class="py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        ...
        <div
            ...
            <form action="{{ route('feetypes.update', $feetype->feetypesID) }}" method="POST"
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <label for="feetypes"
                            ...
                            del Concepto</label>
                        <input type="text" name="feetypes" id="feetypes"
                            value="{{ old('feetypes', $feetype->feetypes) }}" required
